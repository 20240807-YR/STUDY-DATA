...
BRAND_URL = "https://www.amoremall.com/kr/ko/display/brand/detail/all?brandSn=23"
BASE_DIR = Path(__file__).resolve().parent.parent
OUTPUT_CSV = BASE_DIR / "data_csv" / "아모레" / "브랜드23_세부.csv"
...
async def main():
    ...
    async with async_playwright() as p:
        ...
        print("👉 브랜드(brandSn=23) 접속:", BRAND_URL)
